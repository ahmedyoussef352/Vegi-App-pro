...
class _MyProfileState extends State<MyProfile> {
  ...
  Widget _Listtile({required String title, required iconData,required Function onTap}) {
    return InkWell(
      onTap: (){
        setState(() {
          onTap();
          ...
          Column(
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child:
                  //  userProvider.currentUserData.isEmpty
                  // ? 
            //       ListView.builder(
            //         itemCount: userProvider.currentUserData.length,
            //         itemBuilder: (context, index) {
            // UserModel data = userProvider.currentUserData[index];
            ...
            //         return 
                    Column(
                      ...
                      _Listtile(
                          iconData: Icons.shop_outlined, title: "My Orders",
                          onTap: () {
                    ...
                    // );
                      ...
                      _Listtile(iconData: Icons.add_chart, title: "About",
                      onTap: () {
                    // Navigator.of(context).push(
                    //   MaterialPageRoute(
                    //     builder: (context) => WishList(),
